...
| G | `feature-forms/` — input + ngOnChanges (coupled) | `feature-forms` | `[FE] signals: feature form components input output effect` | `chore/110901/111406/signals-feature-form-components-input-output-effect` | open | — |
